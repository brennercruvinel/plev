...
const PENDING_MIGRATION: [&str; 13] = [
    ...
    "crates/basic-ide/src/components/checkbox.rs",
    "crates/basic-ide/src/components/context_menu.rs",
    "crates/basic-ide/src/components/modal.rs",
    "crates/basic-ide/src/components/panel_header.rs",
    "crates/basic-ide/src/views/commit_form.rs",
    "crates/basic-ide/src/views/diff_view.rs",
    "crates/basic-ide/src/views/multi_stack_view.rs",
    "crates/basic-ide/src/views/sidebar.rs",
    "crates/basic-ide/src/views/unassigned_view.rs",
];
