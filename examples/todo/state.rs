...
pub(crate) enum GpuState {
    Uninitialized,
    Ready {
        gpu: plev::gpu::GpuContext,
        text_system: plev::text::TextSystem,
        pool: plev::gpu::texture_pool::TexturePool,
    },
}
...
pub(crate) struct TodoApp {
    pub(crate) window: Option<std::sync::Arc<plev::winit::window::Window>>,
    pub(crate) state: GpuState,
    pub(crate) compositor: plev::compositor::Compositor,
    pub(crate) clock: plev::animation::FrameClock,
...
impl TodoApp {
    pub(crate) fn new() -> Self {
        ...
        Self {
            ...
            compositor: plev::compositor::Compositor::new(),
            clock: plev::animation::FrameClock::new(),
            items: Vec::new(),
            input,
            filter: Filter::All,
            next_id: 1,
