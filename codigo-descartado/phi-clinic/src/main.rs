...
use phi::winit::event::{ElementState, MouseButton, MouseScrollDelta, WindowEvent};
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let attrs = WindowAttributes::default()
            .with_title("phi-clinic — Vista 3D")
            .with_inner_size(phi::winit::dpi::LogicalSize::new(1280, 800));
