...
pub(crate) const CHARACTERS: &[DockCharacter] = &[
    DockCharacter { initial: "*", name: "Sparkle", online: false, bg_color: SPARKLE_BG, accent_color: SPARKLE_BG },
    DockCharacter { initial: "W", name: "Wizard", online: true, bg_color: WIZARD_BG, accent_color: WIZARD_ACCENT },
    DockCharacter { initial: "U", name: "Unicorn", online: true, bg_color: UNICORN_BG, accent_color: UNICORN_ACCENT },
    DockCharacter { initial: "M", name: "Monkey", online: true, bg_color: MONKEY_BG, accent_color: MONKEY_ACCENT },
    DockCharacter { initial: "R", name: "Robot", online: false, bg_color: ROBOT_BG, accent_color: ROBOT_ACCENT },
];
...
pub(crate) fn smooth_n(current: f32, target: f32, speed: f32) -> f32 {
    let diff = target - current;
    if diff.abs() < 0.005 { target } else { current + diff * speed }
}
