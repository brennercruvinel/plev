use phi::compositor::{Compositor, SceneNode};
use super::{WorkspaceView, ThemeMode, HEADER_H, RESIZE_HANDLE_W, SIDEBAR_W};
...
impl WorkspaceView {
    ...
    pub fn render(&mut self, compositor: &mut Compositor) {
        ...
        // -- Header --
        self.header.render(compositor, theme, self.theme_mode, vw, SIDEBAR_W);
        ...
        let commit_form_h = self.commit_form.render(
            compositor, theme,
            left_x, content_y,
            self.left_w,
        );
        ...
        self.unassigned.render(
            compositor, theme,
            left_x, content_y + commit_form_h,
            self.left_w, content_h - commit_form_h,
            hover_row,
        );
