...
use phi::compositor::{Compositor, LayerId};
use phi::dispatch::ActionQueue;
use phi::overlay::OverlayManager;
...
/// Three-panel workspace layout — mirrors GitButler's MainViewport.
