//! parser: a parse-resolve-emit transpiler poc. UI source from another
...
pub fn transpile_gpui(rust: (&str, &str)) -> Result<Transpiled, ParserError> {
