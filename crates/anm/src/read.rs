//! anm v0 decoder: parses the container of doc/anm-format-v0.md back
...
pub enum ReadError {
    ...
    #[error("bad magic; not an anm file")]
    BadMagic,
...
/// Everything one anm file carries, mirroring the inputs of
/// [`crate::write::encode`].
...
/// Decode a v0 anm file. Inverse of [`crate::write::encode`] up to
