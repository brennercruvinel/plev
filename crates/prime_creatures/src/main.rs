...
//!
//! Run: `cargo run -p prime_creatures` (desktop). Web: `trunk serve` from
//! crates/prime_creatures (WebGPU only, Chrome/Edge 113+).
...
use plev::compositor::{Compositor, ResolveResources};
...
use prime_creatures::sim::{Simulation, params};
    ...
    fn render(&mut self) {
        ...
        let mut encoder = gpu
            ...
            .create_command_encoder(&wgpu::CommandEncoderDescriptor {
                label: Some("prime_creatures_frame"),
            });
