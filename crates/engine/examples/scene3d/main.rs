...
use engine::winit::event::{ElementState, MouseButton, MouseScrollDelta, WindowEvent};
...
impl App {
    ...
    fn render(&mut self) {
        ...
        let mut encoder = gpu
            .device
            .create_command_encoder(&wgpu::CommandEncoderDescriptor { label: Some("3d") });
...
impl ApplicationHandler for App {
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        ...
        let attrs = WindowAttributes::default()
            .with_title("plev-scene3D — Vista 3D")
            .with_inner_size(engine::winit::dpi::LogicalSize::new(1280, 800));
