...
impl TextInputApp {
    pub fn render(&mut self) {
        ...
        self.compositor.draw_text(
            TextNodeKey::from_style("TEXT INPUT DEMO", &style(24.0, 30.0), Some(vw - 64.0)),
            32.0,
            16.0,
            TEXT,
        );
        ...
        for (i, input) in self.inputs.iter().enumerate() {
            ...
            self.compositor.draw_text(
                TextNodeKey::from_style(labels[i], &style(11.0, 15.0), Some(input_w - 20.0)),
                input_x + 10.0,
                card_y + 8.0,
                LABEL_COLOR,
            );
    ...
    fn build_preview(
        ...
        self.compositor.draw_text(
            TextNodeKey::from_style("LIVE PREVIEW", &style(13.0, 17.0), Some(preview_w - 20.0)),
            preview_x + 10.0,
            preview_y + 10.0,
            ACCENT,
        );
        ...
        for (i, (input, label)) in self.inputs.iter().zip(labels.iter()).enumerate() {
            ...
            self.compositor.draw_text(
                TextNodeKey::from_style(&text, &style(14.0, 20.0), Some(preview_w - 20.0)),
                preview_x + 10.0,
        ...
        self.compositor.draw_text(
            TextNodeKey::from_style(&focus_text, &style(11.0, 15.0), Some(preview_w - 20.0)),
            preview_x + 10.0,
            preview_y + 120.0,
            TEXT_DIM,
        );
