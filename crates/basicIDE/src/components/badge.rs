...
impl BadgeKind {
    fn colors(self, theme: &Theme) -> (Color, Color) {
        match self {
            BadgeKind::Pop => (
                Color::rgba(theme.pop.0[0], theme.pop.0[1], theme.pop.0[2], 0.15),
                theme.pop,
            ),
            BadgeKind::Danger => (
                Color::rgba(
            ...
            BadgeKind::Safe => (
                Color::rgba(theme.safe.0[0], theme.safe.0[1], theme.safe.0[2], 0.15),
                theme.safe,
            ),
            BadgeKind::Warn => (
                Color::rgba(theme.warn.0[0], theme.warn.0[1], theme.warn.0[2], 0.15),
                theme.warn,
            ),
            BadgeKind::Purple => (
                Color::rgba(
