...
pub fn present_frame(
    ...
    // Shape and upload text for dirty layers, one resolve per clip group
    // so the ranges patched into the draw sequence line up 1:1 with its
    // Text commands.
