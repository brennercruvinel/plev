...
- [ ] considerar impacto no modelo atual (sem arvore de componentes explicita no φ)
...
- φ nao tem arvore de componentes retida, implementar merge_up pode requerer mudar o modelo ou limitar ao subset de flags paint vs layout
