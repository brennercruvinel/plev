...
function updateActiveButton(theme) {
	// Remove .active class from the theme-mode buttons (the palette buttons in
	// the same dropdown are managed by palette-switcher.js).
	document.querySelectorAll('#theme-switcher .theme-modes button').forEach(button => {
