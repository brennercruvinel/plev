return {
  ...
  lnk = { "edt-flash-novo", "plev", "ref-study", "rsh-notes" },
  txt = [[
...
c. codec em crate novo (3-char, ex: monster): encoder (cena A,B -> delta),
...
PartialEq em SceneNode (1 linha). spec consolidada: doc/monster-format-v0.md.
...
decisao de roadmap: tier 1 de interatividade do monster = track de SM
...
obrigatoria antes de tocar no monster: ref/lottie/study-samples.lua.
]],
}
