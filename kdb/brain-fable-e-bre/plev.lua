return {
  ...
  dat = "2026-06-11",
  ttl = "o pecado semantico do flash e os olhos do plev",
  lnk = { "ths-compilador", "monster-formato", "org-docs" },
  txt = [[
...
falharam porque tinham um so backend e ele era cego. o plev nao pode
...
nlp leve no build (ver monster-formato), narrando o movimento pra quem nao ve.
]],
}
