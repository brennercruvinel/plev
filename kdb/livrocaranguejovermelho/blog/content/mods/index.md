...
Mods enhance/change some Brenner visuals. They are updated alongside Brenner to ensure that you don't need to manually update them every release.
...
```scss
@import "../themes/brennercruvinel.com/sass/_variables.scss";
...
Prefer the less fancy look of the article list used in Brenner some time ago (to some extent)? It can be done with the `classic-article-list` mod:

![classic article list](https://files.catbox.moe/yf5feo.png)

```scss
@use "../themes/brennercruvinel.com/sass/mods/classic-article-list";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/classic-nav";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/sticked-nav";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/classic-del";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/modern-headings";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/modern-hr";
```
...
```scss
@use "../themes/brennercruvinel.com/sass/mods/no-edge-highlight";
```
