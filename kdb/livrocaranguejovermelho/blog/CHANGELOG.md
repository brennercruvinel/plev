...
- Add Brenner "mods" as a replacement to "tricks" (#88).
...
- **[BREAKING]** Change the way `--bg-color` CSS variable works. See [Tricks](https://brennercruvinel.com/tricks/#background-image) page to see how to make background images work.
...
- Replace language-specific pages with symlinks (only affects Brenner demo).
...
- Replace leftover tabi paths with Brenner.
...
- Make Brenner more XHTML5 compliant (in theory).
...
- Add section pointing out to Brenner assets source.
- Add section with tools used to create Brenner.
...
- Add Brenner version to the stylesheet.
